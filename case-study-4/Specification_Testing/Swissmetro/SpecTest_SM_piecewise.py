...
B_TRAIN_TIME3	 = Beta('B_TRAIN_TIME3',0,-1,1,0)
B_TRAIN_TIME4	 = Beta('B_TRAIN_TIME4',0,-1,1,0)
...
TRAIN_TT1  = DefineVariable('TRAIN_TT1',min(TRAIN_TT ,90), database)
TRAIN_TT2  = DefineVariable('TRAIN_TT2',max(0,min( TRAIN_TT   -  90 ,90)), database)
TRAIN_TT3  = DefineVariable('TRAIN_TT3',max(0,min( TRAIN_TT   -  180 ,90)), database)
TRAIN_TT4  = DefineVariable('TRAIN_TT4',max(0, TRAIN_TT   -  270 ), database)
one  = DefineVariable('one',1, database)

#Utilities
Car_SP = ASC_CAR * one + B_CAR_TIME * CAR_TT + B_CAR_COST * CAR_CO
SBB_SP = ASC_SBB * one + B_TRAIN_TIME1 * TRAIN_TT1 + B_TRAIN_TIME2 * TRAIN_TT2 + B_TRAIN_TIME3 * TRAIN_TT3 + B_TRAIN_TIME4 * TRAIN_TT4 + B_TRAIN_COST * TRAIN_COST + B_HE * TRAIN_HE + B_GA * GA
...
biogeme.modelName = "SpecTest_SM_piecewise"
