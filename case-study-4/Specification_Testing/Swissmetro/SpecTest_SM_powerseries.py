...
B_TRAIN_TIME_SQ	 = Beta('B_TRAIN_TIME_SQ',0,-1,1,0)
...
TRAIN_TT_SQ  = DefineVariable('TRAIN_TT_SQ', TRAIN_TT   *  TRAIN_TT, database  )
one  = DefineVariable('one',1, database)

#Utilities
Car_SP = ASC_CAR * one + B_CAR_TIME * CAR_TT + B_CAR_COST * CAR_CO
SBB_SP = ASC_SBB * one + B_TRAIN_TIME * TRAIN_TT + B_TRAIN_TIME_SQ * TRAIN_TT_SQ + B_TRAIN_COST * TRAIN_COST + B_HE * TRAIN_HE + B_GA * GA
...
biogeme.modelName = "SpecTest_SM_powerseries"
